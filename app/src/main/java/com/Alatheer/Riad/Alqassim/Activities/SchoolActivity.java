...
import com.Alatheer.Riad.Alqassim.Adapters.All_Activities_Adapter;
...
public class SchoolActivity extends AppCompatActivity {
    ...
    private void getDataFromServer() {
        ...
        Call<List<AllActivities_Model>> call = service.GetSchoolActivities(school_id);
    ...
    private void initView() {
        ...
        recyclerView = findViewById(R.id.rec_activities);
        model = new ArrayList<>();
